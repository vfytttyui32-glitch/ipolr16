...
# ========== КАТЕГОРИИ (10 шт.) ==========
categories_data = [
    {'name': 'Украшения', 'slug': 'ukrasheniya', 'opisanie': 'Браслеты, кольца, серьги ручной работы'},
    {'name': 'Вязаные изделия', 'slug': 'vyazanye', 'opisanie': 'Шапки, шарфы, свитера'},
    {'name': 'Игрушки', 'slug': 'igrushki', 'opisanie': 'Мягкие игрушки и амигуруми'},
    {'name': 'Деревянные изделия', 'slug': 'derevo', 'opisanie': 'Разделочные доски, статуэтки, рамки'},
    {'name': 'Свечи и мыло', 'slug': 'svechi-mylo', 'opisanie': 'Аромасвечи и натуральное мыло'},
    {'name': 'Картины и постеры', 'slug': 'kartiny', 'opisanie': 'Живопись и графика'},
    {'name': 'Сумки и кошельки', 'slug': 'sumki', 'opisanie': 'Изделия из кожи и ткани'},
    {'name': 'Посуда', 'slug': 'posuda', 'opisanie': 'Керамика и расписная посуда'},
    {'name': 'Открытки', 'slug': 'otkrytki', 'opisanie': 'Авторские открытки и скрапбукинг'},
    {'name': 'Одежда', 'slug': 'odezhda', 'opisanie': 'Авторская одежда и аксессуары'},
]
...
cart_items_per_user = [
    [(products[0], 2), (products[4], 1)],   # Анна: браслет + шапка
    [(products[8], 1), (products[16], 3)],  # Пётр: зайчик + свеча
    [(products[12], 1), (products[24], 2)], # Мария: доска + кружка
    [(products[1], 2), (products[27], 4)],  # Игорь: серьги + открытка
    [(products[20], 1), (products[22], 1)], # Ольга: постер + кошелёк
]
